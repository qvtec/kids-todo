  ...
  return (
    <Layout user={auth.user} title="Home">
      <div className="w-full max-w-md px-2 py-4 sm:px-0">
        <Tab.Group>
          <Tab.List className="flex space-x-1 rounded-xl bg-blue-800 p-1">
            ...
            >
              <Link href="/">
                <div className="h-full w-full">すること</div>
              </Link>
            </Tab>
            <Tab
              className={({ selected }) =>
            ...
            >
              <Link href="/house">
                <div className="h-full w-full">おてつだい</div>
              </Link>
            </Tab>
          </Tab.List>
        </Tab.Group>
      </div>
      <div className="my-2 grid w-full max-w-md gap-2 px-2">
        {filterData?.map((item, i) => (
          <div key={i}>
            ...
            <label
              ...
              className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border-2 bg-white p-5 text-gray-500 peer-checked:bg-gray-200 peer-checked:text-gray-400"
            >
            ...
            <audio id={'schedule_audio_' + item.id} src="/sounds/button-click.mp3"></audio>
          </div>
        ))}
      </div>
      ...
      <button
        type="button"
        className={
          'mb-2 mr-2 rounded-lg px-5 py-3 text-sm font-medium text-white ' + (allDone ? 'bg-blue-700' : 'bg-gray-200')
        }
        disabled={!allDone}
